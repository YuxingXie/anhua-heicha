    ...
    <div class='section'>
      ...
      <div ui-if="activeTab == 2">
        ...
        <form name="aForm" novalidate role="form">
          <div class="input-group" style="margin-bottom: 20px;margin-top: 20px">可用红包：{{totalMembershipPointCount}}</div>
          ...
          <div>
            ...
            <label class="control-label">兑换红包
              <span class="text-danger"ng-if="friendshipExchange && friendshipExchange.mall && !friendshipExchange.mall.exchangeUrl">该商城暂不支持红包兑换</span>
            ...
            <div class="input-group">
              <input type="number" class="form-control" ng-min="1" ng-model="friendshipExchange.pointCount" name="pointCount" ng-max="totalMembershipPointCount" required="true" placeholder="兑换红包数" ng-change="initExchangeMessage()"/>
