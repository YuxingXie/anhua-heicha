...
db.order.insert({ "_class" : "com.lingyun.entity.Order", "productSelectedList" : [ { "amount" : 1, "productSeries" : DBRef("productSeries", ObjectId("591fb65b06fff6e44393f624")) } ], "orderDate" : ISODate("2017-05-03T08:22:25.446Z"), "orderSubmitInfo" : { "self" : false, "acceptAddress" :"广西贵港市港北区江北东路324号", "acceptPersonName" : "星11", "contactPhone" :"13000000005" }, "user" : DBRef("mallUser", ObjectId("591e656a5d94c42611e949c3")),"payStatus" : "y", "payDate" : ISODate("2017-05-02T13:49:49.293Z") })
//4.更新用户(根据测试需要修改日期，根据订单金额设置cost属性值)
db.mallUser.update({"phone":"13000000001"},{"$set":{"cost":8800,"directSaleMember":true,"becomeMemberDate" : ISODate("2017-05-22 13:01")}},false,true)
...
db.mallUser.update({"phone":"18670057061"},{"$set":{"becomeMemberDate" : ISODate("2017-05-04 13:06")}},false,true)
